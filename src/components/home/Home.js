    ...
    return (
        ...
        <div>
            ...
            <Container>
              <CardDeck>
                <Card className="wow fadeIn" data-wow-duration="1000ms" data-wow-delay="300ms">
                  <CardImg top width="100%" src={frontendImg} alt="Card image cap" className="wow scaleIn" data-wow-duration="500ms" data-wow-delay="300ms"/>
                  <CardBlock>
                    <CardTitle>Front-End</CardTitle>
                    <CardText className='text-justify'>Front-End using HTML5, Sass, React, jQuery, Bootstrap 3/4, and  Angular 2.</CardText>
                  </CardBlock>
                </Card>
                <Card className="wow fadeIn" data-wow-duration="1000ms" data-wow-delay="600ms">
                  <CardImg top width="100%" src={backendImg} alt="Card image cap" className="wow scaleIn" data-wow-duration="500ms" data-wow-delay="600ms"/>
                  <CardBlock>
                    <CardTitle>Back-End</CardTitle>
                    <CardText className='text-justify'>Back-End using Node, Express JS, and MongoDB aka MEAN stack, and PHP.</CardText>
                  </CardBlock>
                </Card>
                <Card className="wow fadeIn" data-wow-duration="1000ms" data-wow-delay="900ms">
                  <CardImg top width="100%" src={ProjMan} alt="Card image cap" className="wow scaleIn" data-wow-duration="500ms" data-wow-delay="900ms"/>
                  <CardBlock>
                    <CardTitle>Project Manager</CardTitle>
                    <CardText className='text-justify'>Organized projects for clients across EU, US and the internet, built up and managed developer communities across EMEA.</CardText>
                  </CardBlock>
                </Card>
              </CardDeck>
            </Container>
          ...
          <section className='my-7 bio'>
            <Container>
              <Row>
                <Col xs='12' md='7' className="wow fadeInLeft" data-wow-duration="1000ms" data-wow-delay="300ms">
                  ...
                  <Row>
                    ...
                    <Col md='7'>
                      <h3>411</h3>
                      <p className='text-justify'>I was born in Miami, Florida. I graduated Miami Int University of Art & Design(BA 2010). I've drifted towards full stack development with a range of technologies such as. <br/><br/> <b>HTML5, CSS3, Sass, ES6, NodeJS, Express, MongoDB, jQuery, Angular 2, React, Swift and PHP.</b> In 2014 I moved to Paris to work as community manager for communities of developers in Barcelona, London, Munich, Paris, and Berlin.</p>
                    </Col>
                  </Row>
                </Col>
            ...
            <Container>
              <Row>
                ...
                <Col>
                  ...
                  <h6 className='contact-email'>Email: <a href="mailto:hi@fernandoboza.com">Hi@FernandoBoza.com</a></h6>
                </Col>
              </Row>
            </Container>
          </section>
